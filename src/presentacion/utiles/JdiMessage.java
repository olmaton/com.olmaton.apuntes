...
public class JdiMessage extends javax.swing.JDialog {
    ...
    public void setLabelTitle(String title,String message,Color color,Color colorDark){
        lblTitle.setText(title);
        lblMessage.setText("<html>"+message+"</html>");   
        pnlColor.setBackground(color);
        BotonesEstilos.boton(btnAceptar, colorDark, color, Color.white, Color.white);
    }
